      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="bg-[#1a1a1a] p-6 rounded-xl border border-white/5 h-fit">
             ...
             <div className="text-3xl font-bold mb-2">${game.price?.toLocaleString() || game.salePrice?.toLocaleString()}</div>
             <p className="text-green-500 text-xs font-bold">Available Now</p>
          </div>
        </div>
      </section>
